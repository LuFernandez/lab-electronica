...
Como la función de transferencia en este circuito es $H(s) = \frac{V_R(s)}{V_1}$ y considerando la resistencia del generador, la función de transferencia resulta ser:
...
\begin{figure}[H]
\centering
\includegraphics[scale=0.4]{2_601.png}
\caption{Diagramas del Circuito RC exitado con onda triangular a $600Hz$.}
\label{fig:CR}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[scale=0.4]{2_20k.png}
...
\begin{figure}[H]
\centering
\includegraphics[scale=0.4]{2_198k.png}
